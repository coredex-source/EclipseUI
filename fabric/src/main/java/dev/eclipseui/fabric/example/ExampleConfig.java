package dev.eclipseui.fabric.example;
 ...
 * serialize/deserialize this to a JSON file.
 */
public class ExampleConfig {
    ...
    public void save() {
        // In a real mod, you would serialize to JSON here
        System.out.println("[ExampleConfig] Config saved!");
    }
    
    public void load() {
        // In a real mod, you would deserialize from JSON here
