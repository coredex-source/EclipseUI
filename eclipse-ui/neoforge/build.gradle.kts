...
tasks.processResources {
    inputs.property("version", BuildConfig.getNeoForgeVersionString())
    inputs.property("minecraft_version", BuildConfig.NEOFORGE_MINECRAFT_VERSION)
    inputs.property("minecraft_version_max", BuildConfig.NEOFORGE_MINECRAFT_VERSION_MAX)
    inputs.property("neoforge_version", BuildConfig.NEOFORGE_VERSION)
    
    filesMatching("META-INF/neoforge.mods.toml") {
        expand(
            "version" to BuildConfig.getNeoForgeVersionString(),
            "minecraft_version" to BuildConfig.NEOFORGE_MINECRAFT_VERSION,
            "minecraft_version_max" to BuildConfig.NEOFORGE_MINECRAFT_VERSION_MAX,
...
tasks.jar {
    ...
    archiveVersion.set("${BuildConfig.MOD_VERSION}-neoforge-${BuildConfig.NEOFORGE_MINECRAFT_VERSION_BUILD}")
